...
### Features
* set time goal for books,
* get reading time for each day for the month,
* add books in collections,
* choose theme while reading,
* and other basic stuff for reading a book
* more features related to improve reading on mobile coming soon! (hint is in the forth image above)
